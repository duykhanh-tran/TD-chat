export default function Footer() {
  return (
    <footer className="flex items-center justify-between border-t border-slate-200 bg-white px-6 py-6 lg:px-20 transition-all duration-300" id="contact">
      <div className="flex items-center gap-3">
        <img src="/logo.svg" alt="logo" />
        <a href="/"><h2 className="text-2xl font-extrabold tracking-tight text-[#7C3AED]">Moji</h2></a>
        
      </div>
      <p className="text-sm justify-center font-medium text-slate-500">© 2024 Moji. Tất cả quyền được bảo lưu.</p>
      <div className="flex items-center gap-6">
        <div className="flex items-center gap-4">
          <a className="text-slate-400 hover:text-primary transition-colors" href="https://www.facebook.com/dyu.trn.141">
          ...
          <a className="text-slate-400 hover:text-primary transition-colors" href="https://github.com/duykhanh-tran/TD-chat">
